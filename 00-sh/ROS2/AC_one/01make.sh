...
# AC one
terminator --new-tab --title="L" --working-directory="${workspace}/../../../ROS2/X5_ws" -e "bash -c 'source /opt/ros/humble/setup.bash; rm -rf build install log .catkin_workspace src/CMakeLists.txt && colcon build; exec bash'"
sleep 0.5
