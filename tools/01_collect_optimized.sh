...
main() {
    ...
    gnome-terminal --title="collect" -x $shell_type -i -c "cd ${workspace}/../act; conda activate act; python collect.py --episode_idx -1 --num_episodes 50 --max_timesteps 3600 --frame_rate 60; $shell_exec"
