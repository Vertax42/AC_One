...
# 00_eef_control_ros_openpi.sh - 末端控制脚本 (ros_openpi环境版本)
...
main() {
    ...
    log_info "开始启动ROS2末端控制器 (ros_openpi环境)..."
    ...
    log_info "末端控制说明："
    log_info "1. 使用ros2 topic控制机械臂末端位置"
    log_info "2. 支持EEF六自由度控制"
    log_info "3. 按 Ctrl+C 退出控制系统"
    log_info ""
    log_info "清理说明："
