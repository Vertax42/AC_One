...
bool arm_control__msg__arx_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_control.msg._arx_imu.ArxImu", full_classname_dest, 31) == 0);
  }
  arm_control__msg__ArxImu * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of ArxImu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_control.msg._arx_imu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArxImu");
