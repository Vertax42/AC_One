...
class SingleArm:
    ...
    def set_catch_pos(self, pos: float):
        ...
        print("当前发送夹爪Position:", pos)
        # self.arm.set_arm_status(5)
        # self.arm.set_catch(pos / -3.4)
    ...
    def get_catch_pos(self) -> float:
        """
        Get the current catch position of the arm.

        Returns:
            float: Current catch position.
        """
        return self.arm.get_joint_positions()[-1]
